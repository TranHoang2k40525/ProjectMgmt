  ...
  template: `
    @if (visible) {
      <div 
        ...
        class="fixed z-50 min-w-[220px] bg-slate-900/95 backdrop-blur-xl text-slate-100 border border-slate-700/80 rounded-xl shadow-2xl p-1.5 context-menu-panel focus:outline-none"
        [style.left.px]="x"
        [style.top.px]="y"
...
export class ContextMenuComponent {
  ...
  select(actionType: ContextMenuItemAction['action'], value?: string) {
