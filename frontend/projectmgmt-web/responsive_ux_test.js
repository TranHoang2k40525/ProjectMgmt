...
(async () => {
  ...
  try {
    ...
    // 1.4 Epics Panel Mobile Floating Drawer Test
    console.log('Testing Epics Panel Floating Drawer on Mobile...');
    const epicPanelBtn = await page.$('button:has-text("Epics Panel")');
    if (epicPanelBtn) {
      await epicPanelBtn.click();
      await page.waitForTimeout(500);
    }
    await page.screenshot({ path: 'C:/Users/hoang/.gemini/antigravity/brain/89b0efb9-4947-4929-87b6-eadb839672a9/responsive_mobile_epics_drawer.png' });

    // 1.5 Mobile Scrum Kanban Board
    ...
    // 1.6 Mobile Task Detail Drawer (Full Width 100vw)
    console.log('Testing Task Detail Drawer on Mobile...');
    const firstTaskCard = await page.$('.board-column .p-3\\.5');
    if (firstTaskCard) {
      await firstTaskCard.click();
      await page.waitForTimeout(800);
    }
    await page.screenshot({ path: 'C:/Users/hoang/.gemini/antigravity/brain/89b0efb9-4947-4929-87b6-eadb839672a9/responsive_mobile_task_drawer.png' });
